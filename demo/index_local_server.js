...
function init() {
    var video;
    var url = "http://0.0.0.0:8000/demo/servervideo/my_video_manifest.mpd";
        ...
        for (var index in e) {
            if (index == "request") {
                ...
                if (e[index]["mediaType"] == "video") {
                    log("FRAGMENT" + e[index]["index"] + " starts to load, FRAGMENT starts sat " + e[index]["startTime"] + " with the quality " + e[index]["representationId"], 0)
                }
                else {
                    log2("FRAGMENT" + e[index]["index"] + " starts to load, FRAGMENT starts at " + e[index]["startTime"] + " with the quality " + e[index]["representationId"], 0)
                }
            }
